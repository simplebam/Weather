 ...
 */
package com.yueyue.seeweather.modules.address.ui;
...
import com.yueyue.seeweather.modules.address.adapter.AddressListAdapter;
import com.yueyue.seeweather.modules.address.adapter.PagerViewAdapter;
...
public class AddressCheckActivity extends AppCompatActivity {
    ...
    private void setResultFinish(City province, City city, City district) {
        ...
        if (city == null && district == null) {
            ToastUtil.showShort("程序出现错误,默认选择广州");
            districtName = "广州";
        ...
        if ("其它区".equals(districtName) || "经济技术开发区".equals(districtName)) {
            ToastUtil.showShort("无法识别,请选择其他区域");
            return;
        }
